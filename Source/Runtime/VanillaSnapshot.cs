namespace AtmosphereFX.Runtime
{
    internal static class VanillaSnapshot
    {
        ...
        internal static void ResetCapture() { Infrastructure.PropertyLedger.Forget("AtmosphereFX"); }
        internal static void Restore() { Infrastructure.PropertyLedger.ReleaseAll("AtmosphereFX"); }
    }
}
