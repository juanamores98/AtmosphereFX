...
namespace AtmosphereFX.Infrastructure
{
    ...
    internal static class PropertyLedger
    {
        ...
        internal static void Write(object target, string path, object value, string owner = "AtmosphereFX")
        {
        ...
        internal static void Release(object target, string path, string owner = "AtmosphereFX")
        {
            if (target == null) return;
        ...
        internal static void ReleaseAll(string owner = "AtmosphereFX")
        {
        ...
        internal static void Forget(string owner = "AtmosphereFX")
        {
            foreach (var target in new List<object>(Entries.Keys))
            {
