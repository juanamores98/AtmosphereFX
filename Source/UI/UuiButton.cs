namespace AtmosphereFX.UI
{
    ...
    /// tray is optional: the mod keeps its own hotkey (Ctrl+Alt+A) as fallback.
    /// </summary>
    internal static class UuiButton
    {
        ...
        internal static bool Register(string title, string tooltip, Texture2D icon, Action<bool> onToggle)
        {
            ...
            {
                Debug.LogWarning("[AtmosphereFX v2] Unified UI registration failed: " + e.Message);
                return false;
            }
        }
        ...
        internal static void Unregister()
        {
            ...
            {
                Debug.LogWarning("[AtmosphereFX v2] UUI unregister: " + e.Message);
            }
            finally
            {
                _button = null;
